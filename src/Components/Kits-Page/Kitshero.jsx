...
const Kitshero = () => {
  ...
  <div>
    <div className="">
      <div className=" py-32 px-6 flex justify-center items-center sm:p-16" style={{ backgroundImage: `url(${ez})`, padding:100 ,backgroundSize: 'cover', backgroundPosition: 'top' }}>
        <div className="grid sm:flex justify-items-center sm:justify-center items-center w-full mx-auto  ">
          <div className="w-full sm:px-0 sm:pb-0 max-w-3xl px-6">
            <div className="shadow-lg rounded-lg">
              <div className="md:p-8 p-6 rounded-lg grid justify-items-start items-center md:items-start  text-start backdrop-blur bg-white/40">
                <div className="md:text-4xl text-3xl font-bold pb-4 text-center sm:text-start w-full mb-2  name hexCode">
                ...
                <div className="mx-auto lg:mx-0 mt-0 md:text-xl text-lg  text-start w-full name hexCode">
